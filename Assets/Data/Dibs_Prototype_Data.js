...
ROOM Object:
{
    ...
    distanceFromUser: float // optional field representing distance from user in meters, can be calculated at runtime if needed
}
...
const ROOMS = [
    ...
    },
    {
        ...
        occupancy: [
            0, 0, 2, 30, 32, 28, 25, 10, 8, 22, 24, 18, 16, 4, 2, 1, 0, 0,
        ],
    },
    {
        buildingName: "EITC",
        ...
        occupancy: [
            0, 0, 3, 26, 28, 30, 27, 24, 15, 8, 7, 14, 6, 2, 1, 0, 0, 0,
        ],
    },
    {
    ...
    },
    {
        ...
        occupancy: [
            0, 0, 2, 28, 30, 26, 24, 9, 8, 18, 20, 19, 7, 3, 1, 0, 0, 0,
        ],
    },
    {
        buildingName: "Drake Centre",
        ...
        occupancy: [
            0, 0, 2, 24, 26, 18, 20, 19, 22, 24, 23, 10, 4, 1, 0, 0, 0, 0,
        ],
    },
    {
        buildingName: "Drake Centre",
        ...
        occupancy: [
            0, 0, 3, 30, 32, 34, 33, 31, 29, 28, 26, 12, 6, 2, 1, 0, 0, 0,
        ],
    },
    {
